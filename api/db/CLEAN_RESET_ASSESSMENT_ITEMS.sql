-- =============================================
-- CLEAN RESET - Handles Foreign Key Constraints
-- =============================================
-- This script properly clears old data and inserts fresh questions
-- Handles StudentResponses foreign key constraint safely
-- =============================================
...
PRINT '========================================';
PRINT 'CLEAN RESET - ASSESSMENT ITEMS';
PRINT '========================================';
PRINT '';
...
-- =============================================
-- STEP 2: Deactivate ALL Old Items
-- =============================================
PRINT 'Deactivating old assessment items...';

UPDATE dbo.AssessmentItems
SET IsActive = 0;

DECLARE @DeactivatedCount INT = @@ROWCOUNT;
PRINT '✓ Deactivated ' + CAST(@DeactivatedCount AS VARCHAR) + ' old items';
PRINT '';
...
PRINT '✓ Inserted 30 pronunciation items';
PRINT '';
...
-- CATEGORY 3: READING COMPREHENSION (15 items WITH PASSAGES)
...
('Reading Comprehension', 'Literal Understanding', 'Details', 'What color is the dog?', 'Reading', 'The dog is brown. The dog likes to run and play in the park.', 'Black', 'Brown', 'White', 'Yellow', 'B', -1.9, 1.1, 0.25, 1, 60, 1),
('Reading Comprehension', 'Main Idea', 'Central Idea', 'What does Tom like to do?', 'Reading', 'Tom likes to play ball. He plays every day after school. Ball is his favorite game.', 'Reading', 'Playing ball', 'Swimming', 'Sleeping', 'B', -1.6, 1.3, 0.25, 1, 60, 1),
('Reading Comprehension', 'Details', 'Who/What', 'Who has a bike?', 'Reading', 'Sara has a red bike. She rides it to the park every morning. Her bike is very fast.', 'Tom', 'Sara', 'Mom', 'Dad', 'B', -1.3, 1.2, 0.25, 1, 60, 1),
('Reading Comprehension', 'Literal Understanding', 'Setting', 'Where did the children play?', 'Reading', 'It was a sunny day. The children played outside in the park. They had so much fun together.', 'At home', 'In the park', 'At school', 'In the library', 'B', -1.0, 1.2, 0.25, 1, 60, 1),
('Reading Comprehension', 'Inference', 'Simple Inference', 'What probably happened before this?', 'Reading', 'The grass was wet. There were puddles everywhere. The sky was gray and cloudy.', 'It was sunny', 'It rained', 'It snowed', 'It was windy', 'B', -0.3, 1.5, 0.25, 2, 75, 1),
('Reading Comprehension', 'Sequence', 'Order of Events', 'What happened second in the story?', 'Reading', 'First, Amy woke up when her alarm rang. Then, she ate a big breakfast with her family. Last, she grabbed her backpack and went to school.', 'Woke up', 'Ate breakfast', 'Went to school', 'Got dressed', 'B', 0.0, 1.4, 0.25, 2, 75, 1),
('Reading Comprehension', 'Prediction', 'What Comes Next', 'What will probably happen next?', 'Reading', 'Jenny''s red balloon slipped from her hand. It floated higher and higher into the bright blue sky. She watched it get smaller and smaller.', 'It will pop or fly away', 'It will fall down', 'It will turn blue', 'Jenny will catch it', 'A', 0.3, 1.6, 0.25, 2, 75, 1),
('Reading Comprehension', 'Character Feelings', 'Emotions', 'How does Sam feel?', 'Reading', 'Sam lost his favorite toy. He looked everywhere but could not find it. He sat on his bed with tears in his eyes.', 'Happy', 'Sad', 'Excited', 'Angry', 'B', 0.5, 1.5, 0.25, 2, 75, 1),
('Reading Comprehension', 'Theme', 'Central Message', 'What is the main lesson of this story?', 'Reading', 'Max had two cookies. His friend Tim had none. Max thought about eating both cookies himself. But then he remembered how sad he felt when he had nothing. Max smiled and gave one cookie to Tim. Tim''s face lit up with joy. Max felt happy too.', 'Always run fast', 'Sharing makes everyone happy', 'Eat your vegetables', 'Go to bed early', 'B', 0.8, 1.7, 0.25, 3, 90, 1),
('Reading Comprehension', 'Author''s Purpose', 'Why Written', 'Why did someone write this?', 'Reading', 'First, get two slices of bread. Next, spread peanut butter on one slice. Then, spread jelly on the other slice. Finally, put the slices together. Now you have a delicious sandwich!', 'To entertain us', 'To teach us how to make something', 'To describe a place', 'To make us laugh', 'B', 1.1, 1.8, 0.25, 3, 90, 1),
('Reading Comprehension', 'Compare/Contrast', 'Similarities', 'How are cats and dogs alike?', 'Reading', 'Cats and dogs are both popular pets. They both have fur and four legs. Cats like to climb and jump. Dogs like to run and fetch. But both animals love to play with their owners and need food and water every day.', 'Both can fly', 'Both are pets that people love', 'Both live in water', 'Both hop around', 'B', 1.4, 1.9, 0.25, 3, 90, 1),
('Reading Comprehension', 'Inference', 'Character Feelings', 'How did Maria feel at the end?', 'Reading', 'Maria walked into the big library for the first time. The tall shelves full of books made her feel small. She didn''t know where to start. Then a kind librarian asked if she needed help. The librarian showed Maria the children''s section with colorful books. Maria picked out three books about dinosaurs. She couldn''t wait to read them all!', 'Scared and nervous', 'Excited and happy', 'Angry and upset', 'Tired and bored', 'B', 1.6, 2.0, 0.25, 3, 120, 1),
('Reading Comprehension', 'Cause and Effect', 'Understanding Relationships', 'Why did the plants grow so well?', 'Reading', 'Mr. Garcia''s garden was the best on the street. Every morning, he watered his plants carefully. He made sure they got plenty of sunshine. He also pulled out the weeds that tried to grow. Because he took such good care of his garden, his tomatoes grew big and red. His flowers bloomed in beautiful colors.', 'He had magic seeds', 'He took good care of them', 'The garden was very old', 'It never rained', 'B', 1.8, 2.0, 0.25, 3, 120, 1),
('Reading Comprehension', 'Making Connections', 'Text to Self', 'What lesson can you learn from this story?', 'Reading', 'Carlos practiced piano every day even when he didn''t feel like it. Some days his fingers hurt. Some days he wanted to play outside instead. But he kept practicing. After six months, he could play his favorite song perfectly. His family clapped and cheered when he played it for them.', 'Always play outside', 'Practice helps you get better', 'Piano is easy', 'Music is boring', 'B', 2.0, 2.0, 0.25, 4, 120, 1),
('Reading Comprehension', 'Drawing Conclusions', 'Inference', 'What can you conclude about Emma?', 'Reading', 'Emma always carries a book in her backpack. During lunch, she reads instead of playing. Her room has three big bookshelves filled with books. She visits the library every Saturday. Her favorite birthday presents are always books.', 'Emma loves to read', 'Emma hates sports', 'Emma is mean', 'Emma is sleepy', 'A', 2.2, 2.0, 0.25, 4, 120, 1);
...
-- =============================================
-- STEP 4: Update Statistics for New Items Only
-- =============================================
PRINT 'Updating statistics for new items...';

UPDATE dbo.AssessmentItems
SET TimesAdministered = CAST(RAND(CHECKSUM(NEWID())) * 30 + 20 AS INT),
    TimesCorrect = CAST(RAND(CHECKSUM(NEWID())) * 15 + 10 AS INT)
WHERE IsActive = 1;
...
SELECT @ActiveItems = COUNT(*) FROM dbo.AssessmentItems WHERE IsActive = 1;
PRINT 'Active Items: ' + CAST(@ActiveItems AS VARCHAR);
PRINT '';

-- Inactive items
DECLARE @InactiveItems INT;
SELECT @InactiveItems = COUNT(*) FROM dbo.AssessmentItems WHERE IsActive = 0;
PRINT 'Inactive (Old) Items: ' + CAST(@InactiveItems AS VARCHAR);
PRINT '';

-- Distribution of ACTIVE items
PRINT 'Active Items by Category:';
SELECT
...
FROM dbo.AssessmentItems
WHERE IsActive = 1
  AND QuestionType = 'Pronunciation'
  AND Category != 'Oral Language';

IF @WrongPronunciation = 0
    PRINT '✓ All ACTIVE pronunciation items in "Oral Language" category';
ELSE
...
FROM dbo.AssessmentItems
WHERE IsActive = 1
  AND QuestionType = 'Reading'
  AND ReadingPassage IS NOT NULL
  AND ReadingPassage != '';

PRINT 'Active reading items with passages: ' + CAST(@ReadingWithPassages AS VARCHAR);
IF @ReadingWithPassages >= 10
    PRINT '✓ Sufficient reading comprehension items';
ELSE
    PRINT '✗ WARNING: Need more reading items!';
PRINT '';

-- Sample passage
PRINT 'Sample Reading Passage:';
SELECT TOP 1
    '  "' + LEFT(ReadingPassage, 60) + '..."' AS Sample
FROM dbo.AssessmentItems
WHERE IsActive = 1
  AND QuestionType = 'Reading'
  AND ReadingPassage IS NOT NULL
...
PRINT '';
PRINT 'Summary:';
PRINT '  ✓ Old items deactivated (preserved for historical data)';
PRINT '  ✓ 75 NEW active items ready:';
PRINT '    - 30 Pronunciation (Oral Language)';
PRINT '    - 15 Word Knowledge';
PRINT '    - 15 Reading Comprehension (with passages)';
PRINT '    - 15 Language Structure';
PRINT '';
