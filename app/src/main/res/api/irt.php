...
class ItemResponseTheory {
     ...
     * 
     * @param array $responses Array of ['itemID', 'isCorrect', 'a', 'b', 'c']
     ...
     * @return array Selected item with maximum information
     */
...
if (php_sapi_name() === 'cli') {
    ...
    // Test item selection
    $availableItems = [
        ['itemID' => 1, 'a' => 1.2, 'b' => -1.0, 'c' => 0.25],
        ['itemID' => 2, 'a' => 1.5, 'b' => 0.5, 'c' => 0.25],
        ['itemID' => 3, 'a' => 1.8, 'b' => 0.6, 'c' => 0.25],
    ];
    
    $nextItem = $irt->selectNextItem($estimatedTheta, $availableItems);
    echo "Next recommended item: ID " . $nextItem['itemID'] . "\n";
    echo "Item difficulty (b): " . $nextItem['b'] . "\n";
}
?>