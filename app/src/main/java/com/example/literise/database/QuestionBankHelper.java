...
public class QuestionBankHelper extends SQLiteOpenHelper {
    ...
    private void insertSampleQuestions(SQLiteDatabase db) {
        // Category 1: Oral Language - Vocabulary (6 questions)
        ...
        insertSampleQuestion(db, 1, "Phonological", "multiple_choice",
                "Which word rhymes with 'cat'?",
                null, null,
                "[\"bat\",\"car\",\"cup\",\"dog\"]",
                "bat", -1.2, 1.0, "Listen to the ending sounds!");

        insertSampleQuestion(db, 1, "Phonological", "multiple_choice",
                "How many syllables are in 'elephant'?",
                null, null,
                "[\"2\",\"3\",\"4\",\"5\"]",
                "3", 0.5, 1.4, "Clap it out: e-le-phant!");

        insertSampleQuestion(db, 1, "Phonological", "multiple_choice",
                "Which word starts with the same sound as 'sun'?",
                null, null,
                "[\"moon\",\"star\",\"sock\",\"rain\"]",
                "sock", -0.8, 1.1, "Listen to the first sound: /s/");
    ...
    private void insertSampleQuestion(SQLiteDatabase db, int category, String subcategory,
                                     ...
                                     String optionsJson, String correct, double difficulty,
                                     double discrimination, String hint) {
        ContentValues values = new ContentValues();
